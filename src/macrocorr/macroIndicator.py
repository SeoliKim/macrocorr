...
class macroIndicator:
    ...
    mi_dict_temp = {
        ...
        "Bonds": ["SP.DYN.CBRT.IN", 1, 1, 'finance'],
        ...
        "Foreign direct investment": ["BN.KLT.DINV.CD", 1, 1, 'finance'],
        ...
        "International migrant stock": ["SM.POP.TOTL", 1, 1, 'finance'],
        "International tourism": ["ST.INT.ARVL", 1, 1, 'economy'],
        ...
        "Population": ["SP.POP.TOTL", 1, 1, 'population'],
        ...
        "Stock Markets": ["CM.MKT.TRAD.CD", 1, 1, 'finance'],
